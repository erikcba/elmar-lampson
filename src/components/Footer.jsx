                ...
                <div className='flex sm:flex-row flex-col w-full justify-between sm:items-center items-start sm:gap-8 gap-10'>
                    ...
                    <div>
                        ...
                        <div className='flex flex-row gap-4 pt-4'>
                            <a href="https://www.instagram.com/elmarlampson/" target="_blank" rel="noreferrer" className='p-2 rounded-full bg-white'>
                            ...
                            <a href="https://www.linkedin.com/search/results/all/?fetchDeterministicClustersOnly=true&heroEntityKey=urn%3Ali%3Afsd_profile%3AACoAAE0f1IABe4DhJOGmgchKYW75GQOT6wGaLNg&keywords=elmar%20lampson&origin=RICH_QUERY_SUGGESTION&position=0&searchId=5116bbfe-690d-48d0-802c-2a46fade8730&sid=ZFv&spellCorrectionEnabled=false" target="_blank" rel="noreferrer" className='p-2 rounded-full bg-white'>
