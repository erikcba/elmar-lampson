  ...
  return (
    <div className='container mx-auto px-0 xl:pt-0 pt-12'>
      <div className='relative'>
        ...
        <HamburgerMenu toggleMenu={toggleMenu} theme={theme} className={`hamburger-menu absolute right-15 md:left-1/4 md:translate-x-16 xl:top-1/7 top-1 cursor-pointer ${isOpen ? 'opacity-0' : 'opacity-100 transition-opacity duration-1000 '}`} />
        <span
