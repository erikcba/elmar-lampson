    ...
    <div className='container mx-auto px-0 md:pt-12 xl:pt-0 pt-12'>
      <div className='relative'>
        ...
        <span
          ...
          className={`absolute md:left-2/7 md:translate-x-25 right-0 top-1 md:top-4 lg:left-55 2xl:left-50 2xl:translate-x-75 2xl:top-8 md:text-2xl xl:translate-x-75 xl:top-4 xl:left-25 text-xl w-fit font-bold ${bgLang} ${hide} rounded-full py-3 px-2 leading-none cursor-pointer select-none`}
        >
          {t('language')}
        </span>
      </div>
