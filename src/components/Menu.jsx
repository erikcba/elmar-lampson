                    ...
                    <div className="container mx-auto h-full lg:pb-32 lg:pt-12 relative 2xl:px-0 px-6">
                        ...
                        <div className="relative">
                            ...
                            <span
                                ...
                                className={`absolute md:left-2/7 lg:left-50 xl:left-75 xl:top-2 md:translate-x-20 md:top-3 md:mt-0 mt-12 left-53 2xl:top-8 2xl:left-100 bg-white top-14 md:text-2xl text-xl w-fit font-bold rounded-full py-3 px-2 leading-none cursor-pointer select-none`}
                            >
                                {t('language')}
                            </span>
                        </div>
                        ...
                        <div className="flex sm:flex-row flex-row-reverse items-center justify-center w-full ">
                            ...
                            <ul className="w-1/2 flex flex-col items-start justify-start md:pl-24 gap-6 md:pt-0 pt-12">
                                <Link to="/news">
                                    <li className="text-4xl 2xl:text-6xl font-bold text-left text-sky cursor-pointer">News</li>
                                </Link>
                                <Link to="/about">
                                    <li className="text-4xl 2xl:text-6xl font-bold text-left text-sky cursor-pointer">About</li>
                                </Link>
                                <Link to="/myMusic">
                                    <li className="text-4xl 2xl:text-6xl font-bold text-left text-sky cursor-pointer">My music</li>
                                </Link>
                                <Link to="/media" target='_blank' rel='noreferrer' >
                                    <li className="text-4xl 2xl:text-6xl font-bold text-left text-sky cursor-pointer">Media</li>
                                </Link>
                                <Link to="/calendar">
                                    <li className="text-4xl 2xl:text-6xl font-bold text-left text-sky cursor-pointer">Calendar</li>
                                </Link>
                                <a href='#contact' onClick={toggleMenu} >
                                    <li className="text-4xl 2xl:text-6xl font-bold text-left text-sky cursor-pointer">Contact</li>
                                </a>
                            </ul>
                        </div>
                    </div>
